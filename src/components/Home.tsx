    ...
    return (
      <Layout bottomMargin={24}>
            ...
            <section className="flex flex-col lg:flex-row flex-grow w-full justify-between gap-4 p-4 mt-4">
                <Link to="/api-page/face-finder" className='lg:w-half flex-grow flex-shrink rounded-md p-4 shadow hover:scale-101 hover:brightness-102 transition-transform ease-linear dark:bg-darkBox bg-lightBox'>
                ...
                <Link to="/api-page/sumarai" className='lg:w-half flex-grow flex-shrink rounded-md p-4 shadow hover:scale-101 hover:brightness-102 transition-transform ease-linear dark:bg-darkBox bg-lightBox'>
                    <article className='w-full h-full flex flex-col px-2'>
